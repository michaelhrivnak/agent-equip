...
Personal instructions take precedence, in order: `~/.claude/CLAUDE.md`, then `CLAUDE.local.md`,
then `AGENTS.md`. On any conflict, follow the personal instruction and say so.
